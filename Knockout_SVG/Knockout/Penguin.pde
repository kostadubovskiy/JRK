public class Penguin {
  ...
  public Penguin(int team) {
    ...
    m = _radius*.1;
    if(_team == 0) {
      _indicator = new PengButton(_position.x, _position.y, _radius, color(200, 50, 50), color(0, 0, 0), color(255, 255, 255), this, _team);
    } else {
      _indicator = new PengButton(_position.x, _position.y, _radius, color(50, 50, 200), color(0, 0, 0), color(255, 255, 255), this, _team);
    }
